...
//        print_r($infoArt);
    ...
    <h2 class="text-p3 mb-3"><a href="#" class="linkMenu text-p3" idMenu="listarHome">Home</a> <span class="mdi mdi-chevron-right"></span> <a href="#" class="linkMenu text-p3" idMenu="listarArtist">Artistas</a> <span class="mdi mdi-chevron-right"></span> <span class="text-p2"><?php echo $nome; ?></span></h2>
