<div class="container-fluid mt-5 mb-5">
    ...
    $listar = listarRegistrosArte('Felps', 'felpstired');
    ...
    <div class="artistRow">
        ...
        <div id="infoArtist" class="text-p3 artistCol">
            ...
            <h3>Artista:ﾠ<span><a href="#" class="linkMenu text-p3" idMenu="artista<?php echo $nomeArt; ?>"><?php echo $nomeArt; ?></a></span></h3>
            <h3>Descrição:</h3>
...
<div class="modal fade" id="modalAddCompra" tabindex="-1" role="dialog" aria-labelledby="modalAddCompra" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form id="frmAddCompra" name="frmAddCompra" method="post" action="#">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn bg-p1 text-p3" onclick="addCompra();"><span class="mdi mdi-account-plus"></span> Concluir Pedido
                    </button>
                </div>
