...
$listar = listarGeral('idtipopag, tipopag, ativo', 'tbtipopag');
    ...
    <div class="card-body">
        <table class="table table-hover text-center">
            <thead class="bg-p2 text-white">
                <tr>
                    <th scope="col" width="25%"><span class="mdi mdi-cat"></span> ID</th>
                    <th scope="col" width="25%"><span class="mdi mdi-cash-register"></span> Tipo de Pagamento</th>
                    <th scope="col" width="25%"><span class="mdi mdi-alert-circle-outline"></span> Status</th>
                    <th scope="col" width="25%"><span class="mdi mdi-view-dashboard-edit"></span> Ação</th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                ?>
                    ...
                    foreach ($listar as $listarTipoPag) {
                        $id = $listarTipoPag->idtipopag;
                        $tipopag = $listarTipoPag->tipopag;
                        $ativo = $listarTipoPag->ativo;
