...
$listar = listarGeral('idpagamento, idtipopag, valor, ativo', 'tbpagamento');
    ...
    <div class="card-body">
        <table class="table table-hover text-center">
            <thead class="bg-p2 text-white">
                <tr>
                    <th scope="col" width="20%"><span class="mdi mdi-cat"></span> ID</th>
                    <th scope="col" width="20%"><span class="mdi mdi-cash-register"></span> Tipo de Pagamento</th>
                    <th scope="col" width="20%"><span class="mdi mdi-cash"></span> Valor</th>
                    <th scope="col" width="20%"><span class="mdi mdi-alert-circle-outline"></span> Status</th>
                    <th scope="col" width="20%"><span class="mdi mdi-view-dashboard-edit"></span> Ação</th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                ?>
                    ...
                    foreach ($listar as $listarPag) {
                        $id = $listarPag->idpagamento;
                        $idtp = $listarPag->idtipopag;
                        $valor = $listarPag->valor;
                        $ativo = $listarPag->ativo;

                        $listar2 = listarTodosRegistroUNum('tbtipopag', 'tipopag', 'idtipopag', $idtp);
                    ...
                    ?>
                            ...
                            foreach ($listar2 as $listarTipoPag) {
                                $tp = $listarTipoPag->tipopag;
